...
echo rex_view::content(rex_i18n::msg('securit_fe_access_info'));
...
$selActive->setId('securit_fe_access_status');
...
$n = [];
$n['label'] = '<label for="securit_fe_access_status">' . rex_escape($addon->i18n('frontend_access')) . '</label>';
...
$n = [];
$n['label'] = '<label for="securit_fe_access_domains">' . rex_escape($addon->i18n('frontend_access_domains')) . '</label>';
...
$n = [];
$n['label'] = '<label for="fe_access_password">' . $addon->i18n('securit_fe_access_password') . '</label>';
